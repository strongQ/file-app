...
var HomePage = (function () {
    function HomePage(sanitizer, uploadService, appService, navCtrl, menuCtrl) {
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"F:\git\ionic\file-app\src\pages\home\home.html"*/`<ion-header>\n\n  <ion-navbar>\n\n  \n\n    <!-- <button ion-button menuToggle icon-start>\n\n      <ion-icon ios="ios-home" md="md-home"></ion-icon>\n\n      菜单\n\n    </button> -->\n\n<div>\n\n  <ion-row >\n\n    <ion-col  >\n\n      <button  class="menu-button"  ion-button round menuToggle color="secondary">Menu</button>\n\n     \n\n    </ion-col>\n\n    \n\n     <ion-col justify-self-center>\n\n      <div class="center-text">{{homeword}}</div>\n\n     </ion-col> \n\n     <ion-col>\n\n       <div></div>\n\n     </ion-col>\n\n   \n\n  </ion-row>\n\n</div>\n\n  \n\n\n\n   \n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n\n\n\n\n\n\n<ion-content padding>\n\n <ion-list>\n\n   <ion-item>\n\n      <label>选择类型</label>\n\n      <ion-select [(ngModel)]="type">\n\n          <ion-option value="0">娱乐</ion-option>\n\n          <ion-option value="1">风景</ion-option>\n\n      </ion-select>     \n\n   </ion-item>\n\n   <ion-item>\n\n     <label>选择文件</label>\n\n     <input #fileInput type="file" multiple >\n\n     <button ion-button color="secondary"  class="menu-button"  (click)="addFile(fileInput)">添加</button>\n\n   </ion-item>\n\n </ion-list>\n\n  \n\n <ion-list>\n\n   <ion-item *ngFor="let item of items">\n\n     <img width="100" height="100" [src]="item.address">\n\n   </ion-item>\n\n </ion-list>\n\n \n\n</ion-content>\n\n`/*ion-inline-end:"F:\git\ionic\file-app\src\pages\home\home.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4__angular_platform_browser__["c" /* DomSanitizer */], __WEBPACK_IMPORTED_MODULE_3__services_upload_service__["a" /* UploadService */], __WEBPACK_IMPORTED_MODULE_2__services_app_service__["b" /* AppService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* MenuController */]])
    ], HomePage);
    return HomePage;
}());
